    ...
    public class InputState
    {
                                 ...
                                 out PlayerIndex playerIndex)
        {
            return IsNewKeyPress(Keys.Escape, controllingPlayer, out playerIndex) ||
                   IsNewKeyPress(Keys.Delete, controllingPlayer, out playerIndex) ||
        ...
        public bool IsScrollLeft(PlayerIndex? controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.A, controllingPlayer, out playerIndex) ||
                   IsNewButtonPress(Buttons.LeftTrigger, controllingPlayer, out playerIndex) ||
        ...
        public bool IsUsePower(PlayerIndex? controllingPlayer)
        {
            PlayerIndex playerIndex;

            return IsNewKeyPress(Keys.RightControl, controllingPlayer, out playerIndex) ||
